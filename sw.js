const CACHE_NAME = 'deutsch-coach-v159';
const urlsToCache = [
  './',
  './index.html',
  './German_Grammar_Cheat_Codes.html',
  './Mein_Fortschritt.html',
  ...
  './js/sentence-explain.js',
  './js/konnektoren-build.js',
  './js/konnektoren-examples.js',
  './js/konnektoren-posnote.js',
  './js/grammar-scenarios.js',
  './js/icon-svgs.js',
  './js/tamil-dict.js',
  './js/tts-engine.js',
