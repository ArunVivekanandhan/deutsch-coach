...
(function () {
  const DICT = {
    ...
    'Warum?': 'Why?', 'Sätze bauen': 'Build sentences', 'Satz bauen': 'Build the sentence', 'Zwei Sätze verbinden': 'Join two sentences', 'Nebensatz (Verb am Ende)': 'Subordinate clause (verb at the end)', 'Position 1 (Verb sofort)': 'Position 1 (verb right after)', 'Position 0 (ADUSO)': 'Position 0 (ADUSO)', 'Zweiteilig': 'Two-part', 'Neue Runde': 'New round', 'Level': 'Level', 'Art': 'Type', 'Anderer Satz': 'Other sentence', 'Andere Frage': 'Other question', 'Anderes Bild': 'Other picture', 'Leeren': 'Clear', 'Zurück': 'Back', 'Leicht': 'Easy', 'Mittel': 'Medium', 'Schwer': 'Hard', 'Wörter antippen': 'tap the words', 'ohne Hilfe': 'no help', 'letztes Wort': 'last word', 'leeren': 'clear',
  ...
  const UI = 'button,a,label,summary,th,h1,h2,h3,h4,option,legend,[role=tab],.tab,.chip,.section-title,.nav-group-title,.module-title,.module-desc,.srs-label,.progress-label,.dc-more-t,.dc-views-t,.subq,.sub,.muted,.why,.plan,.today-card,.stat,.tile,.area-head,.row';
